...
import TableMain from '@shared/components/tables/TableMain';
import { useAdminDictionary } from '@features/admin/hooks/useAdminDictionary';
            ...
            >
                ...
                <DialogActions sx={{ px: 3, pb: 2 }}>
                    ...
                    <Button
                        ...
                        autoFocus
                    >
                        {dialogContent.confirmText || 'Confirmar'}
                    </Button>
                </DialogActions>
            </Dialog>
        </Box>
