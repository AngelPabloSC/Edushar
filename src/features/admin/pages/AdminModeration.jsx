...
import ReviewContributionDialog from '@features/admin/components/ReviewContributionDialog';
import HistoryDialog from '@features/admin/components/HistoryDialog';
            ...
            >
                ...
                <DialogActions sx={{ px: 3, pb: 2, justifyContent: 'center', gap: 2 }}>
                    ...
                    <Button
                        ...
                        autoFocus
                    >
                        {isProcessing ? 'Procesando...' : (dialogContent.confirmText || 'Confirmar')}
                    </Button>
                </DialogActions>
            </Dialog>
