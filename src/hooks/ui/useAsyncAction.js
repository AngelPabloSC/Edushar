...
/**
 * Hook para manejar acciones asíncronas con prevención automática de ejecuciones duplicadas
 * 
 * @param {Object} options - Opciones de configuración
 * @param {number} options.minDelay - Delay mínimo en ms antes de permitir nueva ejecución (default: 0)
 * @returns {Object} { isExecuting, execute }
 * 
 * @example
 * const { isExecuting, execute } = useAsyncAction({ minDelay: 500 });
 * 
